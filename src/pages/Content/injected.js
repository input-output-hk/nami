...
window.cardano = {
  ...(window.cardano || {}),
  nami: {
    enable: async (extensionPayload) => {
      let CIP95Functions = {};
      let extensions = extensionPayload?.extensions;
      
      if (extensions && Array.isArray(extensions)) {
        if (extensions.some((extension) => extension.cip === 95)) {
          console.info('Nami: Cardano CIP-95 extension is enabled');
